...
#autoapi_type = 'python'
#autoapi_dirs = ['3-guide/efsmi/pyefml']
#autoapi_ignore = ['*test*', '*example*', '*setup*', '*pyefml_int.py*', '*autoapi*']  #skip internal test code
#autoapi_root = './3-guide/efsmi/content/source/autoapi'
#autoapi_generate_api_docs = True #True
#autoapi_template_dir = '3-guide/efsmi/content/source/autoapi_templates_zh'
...
project = u'TopsPlatform'
copyright = u'2024 上海燧原科技股份有限公司 | 备案/许可证编号：<a target="_blank" href="https://beian.miit.gov.cn/#/Integrated/index">沪ICP备18023946号-1</a><a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=31011502008689" style="display:inline-block;text-decoration:none;height:20px;line-height:20px;"><img src="https://support.enflame-tech.com/wp-content/uploads/2023/05/备案图标.png" style="float:left;">沪公网安备 31011502008689号</a>'
author = u'www.enflame-tech.com'
...
breathe_projects = { "Runtime": "./6-api/Runtime/content/source/xml","topscodec":"./6-api/topscodec_cpp_api/content/source/xml","krt": "./6-api/Kernel_Runtime/content/source/xml" ,"cc": "./6-api/topsccapi/content/source/xml" ,"My Project": "./5-program/dllib/topsaten/topsaten_api/content/source/xml","graph": "./5-program/graph/hlir2/content/source/xml", "Inference": "./3-model/infer/topsinference/topsinference_c/content/source/xml"  , "PTI": "./5-develop/topsptiapi/content/source/xml" , "dnn": "./5-program/dllib/topsdnn/topsdnnapi/content/source/xml" , "TopsCV_C": "./5-program/topscv/topscv_c_api/content/source/xml","TOPSTX": "./5-develop/topstx_cpp_api/content/source/xml"}
...
htmlhelp_basename = 'aBriefTutorialOnMakingBeautyDocuments'
...
latex_documents = [
    (master_doc, 'MakingBeautyDocuments.tex', u'A Brief Tutorial On Making Beauty Documents',
     u'Zhi Liu', 'manual'),
]
...
man_pages = [
    (master_doc, 'MakingBeautyDocuments', u'A Brief Tutorial On Making Beauty Documents',
     [author], 1)
]
...
#texinfo_documents = [
#    (master_doc, 'MakingBeautyDocuments', u'Change Detection of SAR Documentation',
#     author, 'www.enflame-tech.com', 'One line description of project.',
#    'Miscellaneous'),
#]
...
html_theme_options = {
    'style_nav_header_background': 'rgba(42, 44, 49, 1)',
    'logo_only': True,
