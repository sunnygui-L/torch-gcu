...
project = 'Torch_GCU2.9用户使用手册'
copyright = '2026, www.enflame-tech.com'
author = 'www.enflame-tech.com'

# The full version, including alpha/beta/rc tags
release = 'V3.7.1'  # 填写当前文档版本号
doc_name = 'Torch-GCU2.9用户使用手册'  # 填写全称, 目前不支持下划线，使用“-”代替
last_update_date = '2026年3月5日'  # 填写文档更新日期，格式为YYYY年MM月DD日
pdf_filename = 'Torch-GCU2.9用户使用手册.tex'  # 填写导出的pdf的tex文件名，格式为"XXXX.tex"，注意不可以含有空格！！！
...
% 设置页边距
\usepackage{geometry}
\geometry{left=3.17cm,right=3.17cm,top=2.08cm,bottom=2.84cm}
