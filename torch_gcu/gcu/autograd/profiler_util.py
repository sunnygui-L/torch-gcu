...
import torch
from torch_gcu.gcu.autograd import DeviceType
...
class EventList(list):
    ...
    def table(
        ...
        Args:
            sort_by (str, optional): Attribute used to sort entries. By default
                ...
                Valid keys include: ``cpu_time``, ``gcu_time``, ``xpu_time``,
                ``cpu_time_total``, ``gcu_time_total``, ``xpu_time_total``,
                ``cpu_memory_usage``, ``gcu_memory_usage``, ``xpu_memory_usage``,
                ``self_cpu_memory_usage``, ``self_gcu_memory_usage``,
                ``self_xpu_memory_usage``, ``count``.
            top_level_events_only(bool, optional): Boolean flag to determine the
                selection of events to display. If true, the profiler will only
                display events at top level like top-level invocation of python
                `lstm`, python `add` or other functions, nested events like low-level
                cpu/gcu/xpu ops events are omitted for profiler result readability.
    ...
    def export_chrome_trace(self, path):
        ...
        device_name = "gcu" if not self._use_device else self._use_device
...
class FormattedTimesMixin:
    ...
    @property
    @deprecated(
        "`gcu_time` is deprecated, please use `device_time` instead.",
        category=FutureWarning,
    )
    def gcu_time(self):  # To be deprecated
...
class FunctionEvent(FormattedTimesMixin):
    ...
    @property
    @deprecated(
        "`self_gcu_memory_usage` is deprecated. Use `self_device_memory_usage` instead.",
        category=FutureWarning,
    )
    def self_gcu_memory_usage(self):  # To be deprecated
    ...
    @property
    @deprecated(
        "`gcu_time_total` is deprecated. Use `device_time_total` instead.",
        category=FutureWarning,
    )
    def gcu_time_total(self):  # To be deprecated
    ...
    @property
    @deprecated(
        "`self_gcu_time_total` is deprecated. Use `self_device_time_total` instead.",
        category=FutureWarning,
    )
    def self_gcu_time_total(self):  # To be deprecated
...
class FunctionEventAvg(FormattedTimesMixin):
    ...
    def __repr__(self):
        device_name = "gcu" if not self.use_device else self.use_device
...
def _build_table(
    ...
    for evt in events:
        ...
        if evt.device_type == DeviceType.CPU and evt.is_legacy:
            ...
            # in kineto profiler, there're events with the correct device type (e.g. GCU)
            sum_self_device_time_total += evt.self_device_time_total
