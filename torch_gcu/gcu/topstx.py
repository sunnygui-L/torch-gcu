...
try:
    from torch_gcu._C import _topstx
except ImportError:
    ...
    class _TOPSTXStub:
        ...
        def _fail(*args, **kwargs):
            raise RuntimeError(
                "TOPSTX functions not installed. Are you sure you have a GCU build?"
            )
    ...
    _topstx = _TOPSTXStub()  # type: ignore[assignment]
...
def range_start(msg) -> int:
    ...
    """
    return _topstx.rangeStartA(msg)
