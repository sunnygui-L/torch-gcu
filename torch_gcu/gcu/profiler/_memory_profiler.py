...
from torch_gcu._C._autograd import _ProfilerResult
...
from torch_gcu.gcu.profiler import _utils
...
class MemoryProfileTimeline:
    ...
    def export_memory_timeline_html(
        ...
        with open(tmpfile.name, "rb") as tmp:
            ...
            html = f"""<html>
<head><meta charset="utf-8" /><title>GCU Memory Timeline HTML</title></head>
<body>
