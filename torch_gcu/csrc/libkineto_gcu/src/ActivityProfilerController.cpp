...
ActivityProfilerController::ActivityProfilerController(
  ...
  // TOPSPTI and GCU driver versions.
  ...
  profiler_ = std::make_unique<TopsptiActivityProfiler>(
      TopsptiActivityApi::singleton(), cpuOnly);
...
void ActivityProfilerController::profilerLoop() {
  torch_gcu::util::setThreadName("TorchKinetoAct");
