...
class TORCH_GCU_API ActivityProfilerInterface {
 public:
  ...
  // Toggle GCU tracing as a trace is running to omit certain parts of a graph
  ...
  virtual void logInvariantViolation(const std::string&, const std::string&,
                                     const std::string&,
                                     const std::string& = "") {}
};
