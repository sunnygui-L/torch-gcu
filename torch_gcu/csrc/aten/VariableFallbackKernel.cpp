...
// void gcu_cpu_fallback(const c10::OperatorHandle& op, torch::jit::Stack*
// stack) {
//   if (!has_op_name_warned(c10::toString(op.schema().operator_name()))) {
//     TORCH_GCU_WARN("CAUTION: The operator '",
//                    op.schema().operator_name(),
//                    "' is not currently supported ",
//                    "on the GCU backend and will fall back to run on the
//                    CPU.", " This may have performance implications.");
//   }
//   at::native::cpu_fallback(op, stack);
// }

// TORCH_LIBRARY_IMPL(_, PrivateUse1, m) {
//   m.fallback(torch::CppFunction::makeFromBoxedFunction<&gcu_cpu_fallback>());
// }

// void gcu_Sparse_fallback(const c10::OperatorHandle& op, torch::jit::Stack*
// stack) {
//   TORCH_CHECK(false, "CAUTION: The operator '",
//               op.schema().operator_name(),
//               "' is not currently supported on the GCU backend.")
// }

// TORCH_LIBRARY_IMPL(_, SparsePrivateUse1, m) {
//   m.fallback(torch::CppFunction::makeFromBoxedFunction<&gcu_Sparse_fallback>());
// }
}  // namespace
