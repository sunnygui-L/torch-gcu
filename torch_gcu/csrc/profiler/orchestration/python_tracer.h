...
using TraceKey = strong::type<uint64_t, struct TraceKey_, strong::regular,
                              strong::hashable, strong::ostreamable>;
...
struct TORCH_API PythonTracerBase {
  ...
  virtual std::vector<std::shared_ptr<Result>> getEvents(
      ...
      std::vector<CompressedEvent>& enters, c10::time_t end_time_ns) = 0;
};
