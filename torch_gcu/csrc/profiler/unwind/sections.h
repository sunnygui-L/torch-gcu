...
#include <torch_gcu/csrc/profiler/unwind/mem_file.h>
#include <torch_gcu/csrc/profiler/unwind/range_table.h>
...
struct Sections {
  ...
  void addDebugInfoRange(uint64_t start, uint64_t end,
