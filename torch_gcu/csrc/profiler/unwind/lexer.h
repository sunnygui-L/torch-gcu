...
struct LexerImpl {
  ...
  T read() {
    ...
    UNWIND_CHECK(!checked || end <= end_, "read out of bounds {} >= {}",
                 (void*)end, (void*)end_);
  ...
  const char* readCString() {
    ...
    UNWIND_CHECK(false, "string is out of bounds {} >= {}", (void*)next_,
                 (void*)end_);
  }
  ...
  int64_t read4or8Length() { return readSectionLength().first; }
  ...
  void* loc() const { return (void*)next_; }
